...
package com.elmocity.ss.trader.parts;
...
public class TraderPart
{
	...
	private final static Logger logger = LoggerFactory.getLogger(TraderPart.class);
...
//	Button connectButton;
	...
	public void postConstruct(Composite parent)
	{
		...
		{
			GridHelpers.addTitlePanel(inputComposite, "Trader Part", 2);
...
//			DataBroker.getInstance().connect(); // "localhost", 7497, 7);
//			
//			console.append("Done.\n");
//		}
//	}
